...
export const createNewResponse = (appId, answers) => {
	return fetch(`${conf.API_BASE_URL}/apps/${appId}/responses`, {
		headers: {
...
export const submitChargeOmise = (amount, currency, token, keyHash) => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/omise`, {
		headers: {
			'Content-Type': 'text/plain',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const updateResponseAnswer = (slug, answer) => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/responses/${slug}/answer`, {
		headers: {
			'Content-Type': 'text/plain',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const updateResponseStatus = (slug, status) => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/responses/${slug}/status`, {
		headers: {
			'Content-Type': 'text/plain',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchDesign = () => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/design`, {
		headers: {
...
export const fetchApp = () => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}`, {
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchAppDetail = () => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/detail`, {
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchConfig = (appId) => {
	return fetch(`${conf.API_BASE_URL}/apps/${appId}/message`, {
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchStartOver = () => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/start-over`, {
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchCredentials = async () => {
	return fetch(`${conf.API_BASE_URL}/credentials`, {
		headers: {
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
		},
...
export const webhook = (payload) => {
	return fetch(`${conf.API_BASE_URL}/webhook`, {
		headers: {
			'Content-Type': 'text/plain',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const sendRequestSMTP = (payload) => {
	return fetch(`${conf.API_BASE_URL}/send-smtp`, {
		method: 'POST',
		headers: {
			'Content-Type': 'text/plain',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
...
export const registerCollectorAccount = () => {
	return fetch(`${conf.API_BASE_URL}/collector-registration?token=${conf.DISTRIBUTE_TOKEN}`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			'X-Version': conf.VERSION
...
export const fetchSpreadsheetData = (spreadsheetId, sheetId) => {
	...
	if (sheetId) {
		return fetch(
			`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/spreadsheets/${spreadsheetId}/sheets/${sheetId}/data`,
			{
				headers: {
					'Content-Type': 'application/json',
					Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
	...
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/spreadsheets/${spreadsheetId}/data`, {
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
...
export const fetchMessageConfig = () => {
	return fetch(`${conf.API_BASE_URL}/apps/${conf.APP_SLUG}/${conf.MODE === 'FULL-PREVIEW' ? 'preview-message' : 'message'}`, {
		headers: {
			Authorization: `Bearer ${conf.ACCESS_TOKEN}`,
			'X-Version': conf.VERSION
		},
