	...
	while (true) {
		...
		try {
			...
			if (
				...
				yield call(apis.startSession, conf.APP_SLUG)
				...
				const humantakeover = yield call(apis.fetchHumantakeoverQueues, roomId)
				yield put(actions.humantakeover(humantakeover || {}))
