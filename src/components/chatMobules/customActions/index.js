...
import { HumanTakeOverView } from '../../../messages/humanTakeOver'
...
import QuickReply from '../../../messages/quickReply'
import VideoRecording from '../../../messages/videoRecording'
import { View } from 'react-native'
import YesNo from '../../../messages/yesno'
import QuantityPanel from '../../../messages/ecommerce/quantityPanel'
...
const CustomActions = (props) => {
	const { currentQuestion, failedMessages, retryErrorMessage, isRetryingErrorMessage, editOrder } = props
	...
	switch (mode) {
		case 'HUMAN-TAKEOVER':
			return <HumanTakeOverView {...props} question={currentQuestion} />
		case 'SINGLE-INPUT':
		...
		case 'QUICK-REPLY':
			return <QuickReply {...props} question={currentQuestion} />
		default:
			return <View />
	}
}
