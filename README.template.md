...
android:
  ...
  environment:
    EXPO_SDK_VERSION: ${APP_EXPO_SDK_VERSION} # << REPLACE WITH THE EXPO SDK VERSION OF YOUR APP
    TURTLE_VERSION: ${TURTLE_VERSION_NEW}   # << REPLACE THE LATEST TURTLE-CLI VERSION HERE
    PLATFORM: android
